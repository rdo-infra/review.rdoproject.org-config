...
function create_config(){{
    ...
    echo "overcloud_image_url_tripleo: http://66.187.229.139/builds-$RELEASE/current-tripleo/overcloud-full.tar"
    echo "ipa_image_url_tripleo: http://66.187.229.139/builds-$RELEASE/current-tripleo/ironic-python-agent.tar"
    echo "images:"
    echo "  - name: overcloud-full"
    echo "    url: \"{{{{ overcloud_image_url_tripleo }}}}\""
    echo "    type: tar"
    echo "  - name: ipa_images"
    echo "    url: \"{{{{ ipa_image_url_tripleo }}}}\""
    echo "    type: tar"
